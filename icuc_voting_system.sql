...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2026 at 08:19 AM
...
INSERT INTO `candidates` (`id`, `category_id`, `full_name`, `registration_number`, `photo`, `manifesto`, `slogan`, `is_independent`, `party_affiliation`, `is_active`, `created_at`) VALUES
(1, 1, 'Aisha Mbabazi', '241-22301-9809', NULL, 'I will improve student welfare', NULL, 0, 'Unity Party', 1, '2026-05-07 06:15:45'),
(2, 1, 'Sharifah Kabali', '241-22323-3232', NULL, 'Fight for academic excellence', NULL, 0, 'Progress Alliance', 1, '2026-05-07 06:15:45'),
(3, 2, 'Sudaice Sonde', '241-22422-9874', NULL, 'Supporting student initiatives', NULL, 0, 'Unity Party', 1, '2026-05-07 06:15:45'),
(4, 3, 'Hassan Sennoga', '241-44909-3333', NULL, 'Transparent communication', NULL, 0, 'Independent', 1, '2026-05-07 06:15:45');
...
(1, 'election_status', 'upcoming', 'upcoming, active, closed', '2026-05-07 06:15:44'),
...
INSERT INTO `students` (`id`, `registration_number`, `full_name`, `mobile_number`, `password`, `email`, `faculty`, `department`, `year_of_study`, `has_voted`, `is_active`, `created_at`, `updated_at`) VALUES
(1, '241-22490-3333', 'Kayondo Ibrahim', '0771234567', '$2y$10$YourHashHere', NULL, 'Computing', 'Computer Science', 2, 0, 1, '2026-05-07 06:15:45', '2026-05-07 06:15:45'),
(2, '241-44343-2312', 'Katasi Sumayya', '0782345678', '$2y$10$YourHashHere', NULL, 'Business', 'Accounting', 3, 0, 1, '2026-05-07 06:15:45', '2026-05-07 06:15:45'),
(3, '241-44232-0987', 'Musa Katungulu', '0753456789', '$2y$10$YourHashHere', NULL, 'Engineering', 'Civil', 4, 0, 1, '2026-05-07 06:15:45', '2026-05-07 06:15:45');
